...
import apps.nocturnuslabs.kotlincourse.location.LocationEntryFragmentDirections
...
class MainActivity : AppCompatActivity(), AppNavigator {
    ...
    override fun navigateToCurrentForecast(zipcode: String) {
        //we declare an action which we want to perform.
        //LocationEntryFragmentDirections class is autogenerated by the compiler when we rebuild the project.
